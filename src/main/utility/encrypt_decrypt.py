...
# print(encrypt("KQW48Co18ePDbG5JoXyUG5zizoxOYUmuSgd++hqs"))
# print(decrypt("mSg6uIZXLIkEqFVxHXziH90ML7dFht+NtRCvTTdKWfPW9qmu8ZotzdwqDT3qspWo"))
print(encrypt("Giveme1$"))