--## agar hm kisi process ko run kr rhe h aur vo beech me fat gya ya complete ho gya
--## to uski information product_staging_table me store hogi
...
VALUES ('youtube-project-testing-vaibhav', 'active', NOW(), NOW());
